...
(function () {
  ...
  const I18N = {
    kk: {
      fAll: 'Барлығы', fMausoleum: 'Кесене', fMosque: 'Жер асты мешіті', fNecropolis: 'Қорым', fNature: 'Табиғат',
    ...
    ru: {
      fAll: 'Все', fMausoleum: 'Мавзолеи', fMosque: 'Подземные мечети', fNecropolis: 'Некрополи', fNature: 'Природа',
      navGuide: 'Гид', navMap: 'Карта', navQr: 'QR',
